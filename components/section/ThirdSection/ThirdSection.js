...
const ThirdSection = ({handleOrderClick}) => {
	return (
		<section className="sd:min-h-[220vh] xy:min-h-[210vh] xz:min-h-[245vh] relative py-20 bg-[#d9d9d9] w-full">
			<div className=''>
				...
				<div className='absolute left-1/2 transform -translate-x-1/2 top-0 z-30 shadow-2xl'>
					<div className="card sd:w-[40vw] xz:w-[80vw] rounded-none shadow-xl bg-white">
						...
						<div className='absolute sd:-z-10 xz:-z-20 sd:top-80 xy:top-[90vh] xz:top-[100vh] sd:-right-72 xz:-right-4 shadow-2xl'>
							<img src='/thirdSection/2.webp' alt='Ремонт дома' className="sd:w-[700px] xz:w-[300px]" />
						</div>

						<div className='absolute z-10 sd:top-[95vh] xy:top-[115vh] xz:top-[128vh] sd:left-0 xz:left-0 shadow-2xl'>
						...
						<div className='absolute z-10 sd:-bottom-[160vh] xy:-bottom-[146vh] xz:-bottom-[170vh] sd:-left-60 xz:-left-0 border-l-8 border-gray-600 pl-5'>
